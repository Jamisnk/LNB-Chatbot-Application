...
namespace Chatbot_Application
{
    public partial class Login : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string connString = @"Data Source=DESKTOP-RG7KVHB\SQLEXPRESS; Initial Catalog=ChatbotDB; 
            ...
            try
            {
                ...
                using (SqlConnection myConnection = new SqlConnection(connString))
                {
                    ...
                    string query = "SELECT EmployeeID, First_Name from Employee WHERE username = @username AND password = @password";
